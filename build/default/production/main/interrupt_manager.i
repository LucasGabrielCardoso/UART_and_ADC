...
# 10 "main/interrupt_manager.c" 2

# 1 "main/adc.h" 1
# 14 "main/adc.h"
    void ADC_Initializer(void);
    uint16_t ADC_Get_Value(uint8_t channel);
# 11 "main/interrupt_manager.c" 2

# 1 "main/interrupt_manager.h" 1
# 34 "main/interrupt_manager.h"
    __attribute__((picinterrupt(("")))) void Interrupt_High_Priority(void);

    extern volatile uint8_t dta[20];
    extern volatile uint8_t *pot;
# 12 "main/interrupt_manager.c" 2

# 1 "main/system_config.h" 1
# 35 "main/system_config.h"
# 1 "main/device_config.h" 1
# 36 "main/system_config.h" 2
# 13 "main/interrupt_manager.c" 2


volatile uint8_t dta[20] = {0};
volatile uint8_t *pot = ((void*)0);
